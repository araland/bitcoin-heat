...
# Transfer
# to create game and rewards


# Game initialization notification to game master server
...
class TextInputBox(pygame.sprite.Sprite):
    def __init__(self, x, y, w, font, text, active, color, backcolor):
        super().__init__()
        self.color = color
    ...
    def render_text(self):
        ...
        self.image.blit(t_surf, (1, 1))
        pygame.draw.rect(self.image, self.color, self.image.get_rect().inflate(-1, -1), 1)
